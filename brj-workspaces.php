...
if (class_exists('FLBuilder')) {
    ...
    require_once BB_THEME_ELEMENTS_DIR . '/classes/class-brj-theme-elements-admin.php';
    ...
    // Admin Actions
    add_action('admin_menu', 'BRJ_ThemeElementsAdmin::admin_menu');
    add_action('admin_enqueue_scripts', 'BRJ_ThemeElementsAdmin::admin_enqueue');
    add_action('wp_before_admin_bar_render', 'BRJ_ThemeElementsAdmin::admin_bar');
    add_action('init', 'BRJ_ThemeElementsAdmin::register_post_types');
    ...
    register_activation_hook( __FILE__, 'BRJ_ThemeElementsAdmin::activate' );
}
?>
